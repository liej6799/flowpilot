...
const LogCameraInfo road_camera_info{
  ...
  // [op9] drop qcam_encoder_info: the qcamera H264 preview is 526x330, but the SM8350 Iris2 venc
  // requires min height 384 and cannot scale ("Unsupported height 384 vs 330; scaling is not
  // supported") -> its start_streaming fails and the kill_session cascade aborts the road/wide
  // HEVC sessions too. Record main HEVC only (qcamera would need a separate pre-downscaler).
