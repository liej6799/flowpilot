...
//
// The COMPLETE mode the HAL streams: BASE_INIT(522) + QSC(3072) + RES(144).
// BASE_INIT + RES captured via kprobe; QSC(3072) shading table captured via a
// bpftrace unrolled-loop dump of camera_io_dev_write (fault-safe, no ramdump).
