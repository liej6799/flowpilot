...
def create_gas_command(packer, idx, apply_start, throttle):
  values = {
    "ALWAYS_ON_1": 5,
    "ALWAYS_ON_2": 0x78,
    "ACC_ACTIVE_1": 32 if apply_start else 0,
    "ACC_ACTIVE_2": 1 if apply_start else 0,

    "GAS_ACTIVE_2": 1 if apply_start and throttle != 1696 else 0, # change this later
    "INV_GAS_ACTIVE_2": 1 if apply_start and throttle == 1696 else 0, #change this later

    "COUNTER": idx,
    "GAS_ACTIVE": 4 if apply_start and throttle != 1696 else 0, # need to check is it based on throttle.
